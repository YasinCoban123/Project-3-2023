...
<main class="OverOnsMain">
        <section class="overons">
          ...
          <h2 class="OverOnsH">Eco-vriendelijkheid</h2>
            <p class="OverOnsP">Duurzaam en verantwoord leven wordt steeds belangrijker 
              en is inmiddels bijna niet meer weg te denken uit ons dagelijks leven. 
              Ook de mode-industrie zet zich hard in om haar stempel op het milieu zo 'groen' mogelijk te maken, 
              want ook hier is duurzaamheid aan de orde van de dag. 
              Duurzaamheid beschermt onze natuurlijke omgeving en de ecologische en menselijke gezondheid. 
              We moeten milieubewuster worden, zodat onze mini-me's 
              en hun kinderen ook nog een fijne wereld hebben om op te leven. 
              We proberen dit al te doen door het gebruik van groene stroom, 
              het scheiden van afval en bijvoorbeeld het rijden in elektrische auto's. 
              Maar er is meer dan dat! Ook bij de productie van schoenen wordt er door de jaren heen 
            ...
            <p class="OverOnsP">Hiervoor wordt er steeds meer gebruik gemaakt van gerecyclede materialen, 
              zoals je oude cola fles (PET flessen). extielstof van gerecycled materiaal is extra stevig, 
              en zeer duurzaam omdat er op deze manier plastic afval uit de oceaan beetje bij beetje verdwijnt. 
            ...
            <p class="OverOnsP">Kurk wordt voornamelijk gebuikt in zolen van schoenen. 
              Kurk wordt verkregen uit de schors van de kurkeik en is 100% natuurlijk, 
            ...
            <p class="OverOnsP">Vooral bij sneakers is de binnenzool gemaakt van comfortabel schuim. 
              Tegenwoordig kan dit ook worden gemaakt op basis van suikerriet. 
              De suikerriet zolen zijn een van de meest innovatieve en 
              milieubewuste uitvindingen op modegebied van dit moment. 
              De schuimzolen op basis van suikerriet dragen namelijk niet bij aan ontbossing van regenwouden, 
              en maken het lopen zeer comfortabel. Daarnaast is het biologisch afbreekbaar!</p>            
           </div>
          </article>
        </section>
        <section class="overons">
          ...
          <h2 class="OverOnsH">Geschiedenis</h2>
            <p class="OverOnsP">SchoenReus is vanaf de allereerste dag - ruim 90 jaar geleden - 
              ...
              Het meest bijzonder was de manier waarop er werd gewerkt: samen werken voor de klant. 
              En samen was iedereen bij SchoenReus een familie.</p>          
          </article>
        </section>
        <section class="overons">
          <article class="OverOnsArticle">
          <h2 class="OverOnsH">Doelstellingen</h2>
            <p class="OverOnsP">“Met schoenen die aan de voet passen, maar niet in iemands hoofd, 
  ...
  <article class="Berkay, over_leden_article">
    <h2>Berkay Onal</h2>
    <div>
    <p class="OverOnsInfo">Hallo, mijn naam is Berkay Onal en ik ben geboren op 20 april 1889.
      Ik heb 369 jaar lang ervaring als manager van marketing bij Schoenreus. Ik heb een schat aan kennis opgedaan in de schoenenindustrie en heb talloze succesvolle strategieën bedacht en uitgevoerd. 
